"""
Django settings for testapp4_6 project.
...
WSGI_APPLICATION = 'testapp4_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp4_6 API",
    "DESCRIPTION": "API documentation for testapp4_6 App",
    "VERSION": "v1",
}
